...
export interface ApiAnimationAnimation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    thumbCam: Schema.Attribute.Relation<'oneToOne', 'api::camera.camera'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCameraTypeCameraType extends Struct.CollectionTypeSchema {
  collectionName: 'camera_types';
  info: {
    displayName: 'CameraType';
    pluralName: 'camera-types';
    singularName: 'camera-type';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCameraCamera extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cameraType: Schema.Attribute.Relation<
      'oneToMany',
      'api::camera-type.camera-type'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiHotspotHotspot extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    animations: Schema.Attribute.Relation<
      'oneToMany',
      'api::animation.animation'
    >;
    createdAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::camera-type.camera-type': ApiCameraTypeCameraType;
